...
Three-phase models automatically use the thin-mantle fast path. It relaxes the
...
`LAYER_THICKNESS` can also be overridden for a compile check:

```
make smoke NLAYERS=2 LAYER_THICKNESS=4
```
